      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <div class="top-search">
                <form name="form1" class="navbar-form navbar-right" action="queryApp" method="post">
            ...
            <div class="main-grids">
                <div class="top-grids">
                    <div class="recommended-info">
                        <h3>查询结果&nbsp;第<s:property value='pageNumber' />页</h3>
                    </div>
                    ...
                    <div class="col-md-4 resent-grid recommended-grid slider-top-grids">
                        ...
                        <div class="resent-grid-info recommended-grid-info" style="float: left;padding-left:10px;">
                            ...
                            <s:if test="%{#app.isAndroid == 1 && #app.isIos == 1}">
                        </s:if>
                            <s:else><br>
                        </s:else>   
                        </div>
                ...
                <li><s:url id="url" action="queryApp">
